...
var require_mapToArray = __commonJS({
  "node_modules/lodash/_mapToArray.js"(exports, module) {
    function mapToArray(map7) {
      var index3 = -1, result = Array(map7.size);
...
var clamp = (min4, max4, v5) => Math.min(Math.max(v5, min4), max4);
var colors2 = {
  transparent: 0,
...
function useTransition(data, props, deps) {
  ...
  if (is.fun(sort3)) {
    transitions.sort((a4, b4) => sort3(a4.item, b4.item));
  }
  let delay = -trail;
  const forceUpdate = useForceUpdate();
...
function hslConvert(o4) {
  ...
  o4 = o4.rgb();
  var r4 = o4.r / 255, g3 = o4.g / 255, b4 = o4.b / 255, min4 = Math.min(r4, g3, b4), max4 = Math.max(r4, g3, b4), h3 = NaN, s4 = max4 - min4, l3 = (max4 + min4) / 2;
  if (s4) {
    if (r4 === max4) h3 = (g3 - b4) / s4 + (g3 < b4) * 6;
    else if (g3 === max4) h3 = (b4 - r4) / s4 + 2;
    else h3 = (r4 - g3) / s4 + 4;
...
function blurf(radius) {
  ...
  return (T3, S4, start2, stop2, step) => {
    ...
    let sum4 = radius0 * S4[start2];
    const s0 = step * radius0;
    const s1 = s0 + step;
    for (let i4 = start2, j4 = start2 + s0; i4 < j4; i4 += step) {
      sum4 += S4[Math.min(stop2, i4)];
    }
    for (let i4 = start2, j4 = stop2; i4 <= j4; i4 += step) {
      sum4 += S4[Math.min(stop2, i4 + s0)];
      T3[i4] = (sum4 + t7 * (S4[Math.max(start2, i4 - s1)] + S4[Math.min(stop2, i4 + s1)])) / w4;
      sum4 -= S4[Math.max(start2, i4 - s0)];
    }
  };
}
function bluri(radius) {
  ...
  return (T3, S4, start2, stop2, step) => {
    if (!((stop2 -= step) >= start2)) return;
    let sum4 = radius * S4[start2];
    const s4 = step * radius;
    for (let i4 = start2, j4 = start2 + s4; i4 < j4; i4 += step) {
      sum4 += S4[Math.min(stop2, i4)];
    }
    for (let i4 = start2, j4 = stop2; i4 <= j4; i4 += step) {
      sum4 += S4[Math.min(stop2, i4 + s4)];
      T3[i4] = sum4 / w4;
      sum4 -= S4[Math.max(start2, i4 - s4)];
    }
  };
}
...
function shuffler(random) {
  return function shuffle(array3, i0 = 0, i1 = array3.length) {
    let m4 = i1 - (i0 = +i0);
    while (m4) {
      const i4 = random() * m4-- | 0, t7 = array3[m4 + i0];
...
function ordinal() {
  ...
  function scale(d3) {
    let i4 = index3.get(d3);
    if (i4 === void 0) {
      if (unknown !== implicit) return unknown;
      index3.set(d3, i4 = domain.push(d3) - 1);
    }
...
function ticker(year2, month2, week, day2, hour2, minute2) {
  ...
  function tickInterval(start2, stop2, count3) {
    ...
    if (i4 === tickIntervals.length) return year2.every(tickStep(start2 / durationYear, stop2 / durationYear, count3));
    if (i4 === 0) return millisecond.every(Math.max(tickStep(start2, stop2, count3), 1));
...
function dISO(d3) {
  var day2 = d3.getDay();
  return day2 >= 4 || day2 === 0 ? timeThursday(d3) : timeThursday.ceil(d3);
}
...
function formatFullYearISO(d3, p4) {
  var day2 = d3.getDay();
  d3 = day2 >= 4 || day2 === 0 ? timeThursday(d3) : timeThursday.ceil(d3);
  return pad(d3.getFullYear() % 1e4, p4, 4);
}
...
function pie_default() {
  ...
  function pie(data) {
    var i4, n4 = (data = array_default2(data)).length, j4, k5, sum4 = 0, index3 = new Array(n4), arcs = new Array(n4), a0 = +startAngle.apply(this, arguments), da = Math.min(tau, Math.max(-tau, endAngle.apply(this, arguments) - a0)), a1, p4 = Math.min(Math.abs(da) / n4, padAngle.apply(this, arguments)), pa = p4 * (da < 0 ? -1 : 1), v5;
    for (i4 = 0; i4 < n4; ++i4) {
      if ((v5 = arcs[index3[i4] = i4] = +value(data[i4], i4, data)) > 0) {
        sum4 += v5;
      }
    }
    if (sortValues != null) index3.sort(function(i5, j5) {
      return sortValues(arcs[i5], arcs[j5]);
    });
    else if (sort3 != null) index3.sort(function(i5, j5) {
      return sort3(data[i5], data[j5]);
    });
    for (i4 = 0, k5 = sum4 ? (da - n4 * pa) / sum4 : 0; i4 < n4; ++i4, a0 = a1) {
      j4 = index3[i4], v5 = arcs[j4], a1 = a0 + (v5 > 0 ? v5 * k5 : 0) + pa, arcs[j4] = {
        data: data[j4],
        index: i4,
        value: v5,
        startAngle: a0,
...
function ascendingComparator(f3) {
  return (d3, x5) => ascending_default2(f3(d3), x5);
}
...
function ticker2(year2, month2, week, day2, hour2, minute2) {
  ...
  function tickInterval(start2, stop2, count3) {
    ...
    if (i4 === tickIntervals.length) return year2.every(tickStep2(start2 / durationYear2, stop2 / durationYear2, count3));
    if (i4 === 0) return millisecond_default.every(Math.max(tickStep2(start2, stop2, count3), 1));
    const [t7, step] = tickIntervals[target / tickIntervals[i4 - 1][2] < tickIntervals[i4][2] / target ? i4 - 1 : i4];
    return t7.every(step);
  }
  return [ticks2, tickInterval];
...
function formatLocale2(locale5) {
  ...
  function newParse(specifier, Z2) {
    return function(string) {
      var d3 = newDate2(1900, void 0, 1), i4 = parseSpecifier(d3, specifier, string += "", 0), week, day2;
      if (i4 != string.length) return null;
      if ("Q" in d3) return new Date(d3.Q);
      if ("s" in d3) return new Date(d3.s * 1e3 + ("L" in d3 ? d3.L : 0));
      if (Z2 && !("Z" in d3)) d3.Z = 0;
      ...
      if ("V" in d3) {
        ...
        if (!("w" in d3)) d3.w = 1;
        if ("Z" in d3) {
          week = utcDate2(newDate2(d3.y, 0, 1)), day2 = week.getUTCDay();
          ...
          week = localDate2(newDate2(d3.y, 0, 1)), day2 = week.getDay();
        ...
        if (!("w" in d3)) d3.w = "u" in d3 ? d3.u % 7 : "W" in d3 ? 1 : 0;
        day2 = "Z" in d3 ? utcDate2(newDate2(d3.y, 0, 1)).getUTCDay() : localDate2(newDate2(d3.y, 0, 1)).getDay();
        d3.m = 0;
        d3.d = "W" in d3 ? (d3.w + 6) % 7 + d3.W * 7 - (day2 + 5) % 7 : d3.w + d3.U * 7 - (day2 + 6) % 7;
      }
      if ("Z" in d3) {
...
var Ir = function(e7, r4) {
  var t7 = (0, import_merge3.default)({}, e7, r4);
  return Gr.forEach(function(e8) {
    (0, import_set2.default)(t7, e8, Lr((0, import_get.default)(t7, e8), t7.text));
  }), t7;
};
      ...
      if (Ln(d4, r5, o4)) {
        ...
        if (f3) {
          if (Gn.includes(f3.type)) if ("inherit" === f3.background || "inherit" === f3.color) {
            ...
            "inherit" === f3.background && (b4 = b4 + ".bg." + p4, h3 = p4), "inherit" === f3.color && (b4 = b4 + ".fg." + p4, g3 = p4), (0, import_set2.default)(r5, s4, "url(#" + b4 + ")"), c9[b4] || (u3.push(jr({}, f3, { id: b4, background: h3, color: g3 })), c9[b4] = 1);
          } else (0, import_set2.default)(r5, s4, "url(#" + l4 + ")");
            ...
            if (f3.colors.map(function(e8) {
              ...
              w4.id = _2, (0, import_set2.default)(r5, s4, "url(#" + _2 + ")"), c9[_2] || (u3.push(w4), c9[_2] = 1);
            } else (0, import_set2.default)(r5, s4, "url(#" + l4 + ")");
          }
        }
        return "break";
