        ...
        if (getOwnPropertySymbols) {
          ...
          for (var i4 = 0; i4 < symbols.length; i4++) {
            if (propIsEnumerable.call(from, symbols[i4])) {
              to3[symbols[i4]] = from[symbols[i4]];
            }
          }
        }
      }
...
var require_overRest = __commonJS({
  "node_modules/lodash/_overRest.js"(exports, module) {
    ...
    function overRest(func, start2, transform) {
      ...
      return function() {
        var args = arguments, index4 = -1, length = nativeMax(args.length - start2, 0), array4 = Array(length);
        while (++index4 < length) {
...
var require_baseDifference = __commonJS({
  "node_modules/lodash/_baseDifference.js"(exports, module) {
    ...
    function baseDifference(array4, values, iteratee, comparator) {
      var index4 = -1, includes = arrayIncludes, isCommon = true, length = array4.length, result = [], valuesLength = values.length;
      if (!length) {
        return result;
      }
      if (iteratee) {
      ...
      outer:
        while (++index4 < length) {
          var value = array4[index4], computed = iteratee == null ? value : iteratee(value);
...
function update() {
  ...
  if (count4) {
    eachSafely(timeouts.splice(0, count4), (t7) => t7.handler());
    pendingCount -= count4;
  }
  if (!pendingCount) {
    stop();
...
var clamp = (min5, max5, v5) => Math.min(Math.max(v5, min5), max5);
var colors2 = {
  transparent: 0,
...
function interpolate(input, inputMin, inputMax, outputMin, outputMax, easing, extrapolateLeft, extrapolateRight, map9) {
...
function useTransition(data, props, deps) {
  ...
  if (is.fun(sort4)) {
    transitions.sort((a4, b4) => sort4(a4.item, b4.item));
  }
  let delay = -trail;
  const forceUpdate = useForceUpdate();
...
function hslConvert(o4) {
  ...
  o4 = o4.rgb();
  var r4 = o4.r / 255, g3 = o4.g / 255, b4 = o4.b / 255, min5 = Math.min(r4, g3, b4), max5 = Math.max(r4, g3, b4), h3 = NaN, s4 = max5 - min5, l3 = (max5 + min5) / 2;
  if (s4) {
    if (r4 === max5) h3 = (g3 - b4) / s4 + (g3 < b4) * 6;
    else if (g3 === max5) h3 = (b4 - r4) / s4 + 2;
    else h3 = (r4 - g3) / s4 + 4;
...
function basis(t15, v0, v1, v22, v32) {
  var t22 = t15 * t15, t32 = t22 * t15;
  return ((1 - 3 * t15 + 3 * t22 - t32) * v0 + (4 - 6 * t22 + 3 * t32) * v1 + (1 + 3 * t15 + 3 * t22 - 3 * t32) * v22 + t32 * v32) / 6;
}
...
function blurf(radius) {
  ...
  return (T3, S4, start2, stop2, step) => {
    ...
    let sum5 = radius0 * S4[start2];
    const s0 = step * radius0;
    const s1 = s0 + step;
    for (let i4 = start2, j4 = start2 + s0; i4 < j4; i4 += step) {
      sum5 += S4[Math.min(stop2, i4)];
    }
    for (let i4 = start2, j4 = stop2; i4 <= j4; i4 += step) {
      sum5 += S4[Math.min(stop2, i4 + s0)];
      T3[i4] = (sum5 + t7 * (S4[Math.max(start2, i4 - s1)] + S4[Math.min(stop2, i4 + s1)])) / w4;
      sum5 -= S4[Math.max(start2, i4 - s0)];
    }
  };
}
function bluri(radius) {
  ...
  return (T3, S4, start2, stop2, step) => {
    if (!((stop2 -= step) >= start2)) return;
    let sum5 = radius * S4[start2];
    const s4 = step * radius;
    for (let i4 = start2, j4 = start2 + s4; i4 < j4; i4 += step) {
      sum5 += S4[Math.min(stop2, i4)];
    }
    for (let i4 = start2, j4 = stop2; i4 <= j4; i4 += step) {
      sum5 += S4[Math.min(stop2, i4 + s4)];
      T3[i4] = sum5 / w4;
      sum5 -= S4[Math.max(start2, i4 - s4)];
    }
  };
}
...
function tickSpec(start2, stop2, count4) {
  const step = (stop2 - start2) / Math.max(0, count4), power = Math.floor(Math.log10(step)), error = step / Math.pow(10, power), factor = error >= e10 ? 10 : error >= e5 ? 5 : error >= e2 ? 2 : 1;
  let i1, i22, inc;
  if (power < 0) {
  ...
  if (i22 < i1 && 0.5 <= count4 && count4 < 2) return tickSpec(start2, stop2, count4 * 2);
  return [i1, i22, inc];
}
...
function tickStep(start2, stop2, count4) {
  stop2 = +stop2, start2 = +start2, count4 = +count4;
  const reverse4 = stop2 < start2, inc = reverse4 ? tickIncrement(stop2, start2, count4) : tickIncrement(start2, stop2, count4);
...
function shuffler(random) {
  return function shuffle(array4, i0 = 0, i1 = array4.length) {
    let m4 = i1 - (i0 = +i0);
    while (m4) {
      const i4 = random() * m4-- | 0, t7 = array4[m4 + i0];
      array4[m4 + i0] = array4[i4 + i0];
      array4[i4 + i0] = t7;
    }
    return array4;
  };
...
function ordinal() {
  ...
  function scale(d3) {
    let i4 = index4.get(d3);
    if (i4 === void 0) {
      if (unknown !== implicit) return unknown;
      index4.set(d3, i4 = domain.push(d3) - 1);
    }
...
var formatTypes_default = {
  ...
  "p": (x5, p4) => formatRounded_default(x5 * 100, p4),
...
function locale_default(locale5) {
  ...
  function newFormat(specifier) {
    ...
    function format3(value) {
      ...
      if (comma && !zero2) value = group4(value, Infinity);
      var length = valuePrefix.length + value.length + valueSuffix.length, padding = length < width ? new Array(width - length + 1).join(fill) : "";
      if (comma && zero2) value = group4(padding + value, padding.length ? width - valueSuffix.length : Infinity), padding = "";
      switch (align) {
        case "<":
...
function ticker(year3, month3, week, day3, hour3, minute3) {
  ...
  function ticks2(start2, stop2, count4) {
    ...
    if (reverse4) [start2, stop2] = [stop2, start2];
  ...
  function tickInterval(start2, stop2, count4) {
    ...
    if (i4 === tickIntervals.length) return year3.every(tickStep(start2 / durationYear, stop2 / durationYear, count4));
    if (i4 === 0) return millisecond.every(Math.max(tickStep(start2, stop2, count4), 1));
...
function ticker2(year3, month3, week, day3, hour3, minute3) {
  ...
  function tickInterval(start2, stop2, count4) {
    ...
    if (i4 === tickIntervals.length) return year3.every(tickStep2(start2 / durationYear2, stop2 / durationYear2, count4));
    if (i4 === 0) return millisecond_default.every(Math.max(tickStep2(start2, stop2, count4), 1));
    const [t7, step] = tickIntervals[target / tickIntervals[i4 - 1][2] < tickIntervals[i4][2] / target ? i4 - 1 : i4];
    return t7.every(step);
  }
  return [ticks2, tickInterval];
...
function formatLocale(locale5) {
  ...
  function newFormat(specifier, formats2) {
    return function(date) {
      var string = [], i4 = -1, j4 = 0, n4 = specifier.length, c9, pad3, format3;
      if (!(date instanceof Date)) date = /* @__PURE__ */ new Date(+date);
      while (++i4 < n4) {
        if (specifier.charCodeAt(i4) === 37) {
          string.push(specifier.slice(j4, i4));
          if ((pad3 = pads[c9 = specifier.charAt(++i4)]) != null) c9 = specifier.charAt(++i4);
          else pad3 = c9 === "e" ? " " : "0";
          if (format3 = formats2[c9]) c9 = format3(date, pad3);
          string.push(c9);
          j4 = i4 + 1;
        }
      }
...
function cornerTangents(x0, y0, x1, y1, r1, rc, cw) {
  var x01 = x0 - x1, y01 = y0 - y1, lo = (cw ? rc : -rc) / sqrt2(x01 * x01 + y01 * y01), ox = lo * y01, oy = -lo * x01, x11 = x0 + ox, y11 = y0 + oy, x10 = x1 + ox, y10 = y1 + oy, x00 = (x11 + x10) / 2, y00 = (y11 + y10) / 2, dx = x10 - x11, dy = y10 - y11, d22 = dx * dx + dy * dy, r4 = r1 - rc, D3 = x11 * y10 - x10 * y11, d3 = (dy < 0 ? -1 : 1) * sqrt2(max3(0, r4 * r4 * d22 - D3 * D3)), cx0 = (D3 * dy - dx * d3) / d22, cy0 = (-D3 * dx - dy * d3) / d22, cx1 = (D3 * dy + dx * d3) / d22, cy1 = (-D3 * dx + dy * d3) / d22, dx0 = cx0 - x00, dy0 = cy0 - y00, dx1 = cx1 - x00, dy1 = cy1 - y00;
...
function arc_default() {
  ...
  function arc() {
    ...
    if (!(r1 > epsilon)) context.moveTo(0, 0);
      ...
      var a01 = a0, a11 = a1, a00 = a0, a10 = a1, da0 = da, da1 = da, ap = padAngle.apply(this, arguments) / 2, rp = ap > epsilon && (padRadius ? +padRadius.apply(this, arguments) : sqrt2(r0 * r0 + r1 * r1)), rc = min3(abs(r1 - r0) / 2, +cornerRadius.apply(this, arguments)), rc0 = rc, rc1 = rc, t05, t15;
      if (rp > epsilon) {
  ...
  arc.innerRadius = function(_2) {
    return arguments.length ? (innerRadius = typeof _2 === "function" ? _2 : constant_default3(+_2), arc) : innerRadius;
  };
  arc.outerRadius = function(_2) {
    return arguments.length ? (outerRadius = typeof _2 === "function" ? _2 : constant_default3(+_2), arc) : outerRadius;
  };
  arc.cornerRadius = function(_2) {
    return arguments.length ? (cornerRadius = typeof _2 === "function" ? _2 : constant_default3(+_2), arc) : cornerRadius;
  };
  arc.padRadius = function(_2) {
    return arguments.length ? (padRadius = _2 == null ? null : typeof _2 === "function" ? _2 : constant_default3(+_2), arc) : padRadius;
  };
  arc.startAngle = function(_2) {
    return arguments.length ? (startAngle = typeof _2 === "function" ? _2 : constant_default3(+_2), arc) : startAngle;
  };
  arc.endAngle = function(_2) {
    return arguments.length ? (endAngle = typeof _2 === "function" ? _2 : constant_default3(+_2), arc) : endAngle;
  };
  arc.padAngle = function(_2) {
    return arguments.length ? (padAngle = typeof _2 === "function" ? _2 : constant_default3(+_2), arc) : padAngle;
  };
...
function line_default(x5, y4) {
  ...
  x5 = typeof x5 === "function" ? x5 : x5 === void 0 ? x2 : constant_default3(x5);
  ...
  line.x = function(_2) {
    return arguments.length ? (x5 = typeof _2 === "function" ? _2 : constant_default3(+_2), line) : x5;
  };
  line.y = function(_2) {
    return arguments.length ? (y4 = typeof _2 === "function" ? _2 : constant_default3(+_2), line) : y4;
  };
  line.defined = function(_2) {
    return arguments.length ? (defined = typeof _2 === "function" ? _2 : constant_default3(!!_2), line) : defined;
  };
...
function pie_default() {
  var value = identity_default3, sortValues = descending_default2, sort4 = null, startAngle = constant_default3(0), endAngle = constant_default3(tau), padAngle = constant_default3(0);
  function pie(data) {
    var i4, n4 = (data = array_default2(data)).length, j4, k5, sum5 = 0, index4 = new Array(n4), arcs = new Array(n4), a0 = +startAngle.apply(this, arguments), da = Math.min(tau, Math.max(-tau, endAngle.apply(this, arguments) - a0)), a1, p4 = Math.min(Math.abs(da) / n4, padAngle.apply(this, arguments)), pa = p4 * (da < 0 ? -1 : 1), v5;
    for (i4 = 0; i4 < n4; ++i4) {
      if ((v5 = arcs[index4[i4] = i4] = +value(data[i4], i4, data)) > 0) {
        sum5 += v5;
      }
    }
    if (sortValues != null) index4.sort(function(i5, j5) {
      return sortValues(arcs[i5], arcs[j5]);
    });
    else if (sort4 != null) index4.sort(function(i5, j5) {
      return sort4(data[i5], data[j5]);
    });
    for (i4 = 0, k5 = sum5 ? (da - n4 * pa) / sum5 : 0; i4 < n4; ++i4, a0 = a1) {
      j4 = index4[i4], v5 = arcs[j4], a1 = a0 + (v5 > 0 ? v5 * k5 : 0) + pa, arcs[j4] = {
        data: data[j4],
        index: i4,
        value: v5,
        startAngle: a0,
  ...
  pie.value = function(_2) {
    return arguments.length ? (value = typeof _2 === "function" ? _2 : constant_default3(+_2), pie) : value;
  };
  pie.sortValues = function(_2) {
    return arguments.length ? (sortValues = _2, sort4 = null, pie) : sortValues;
  };
  pie.sort = function(_2) {
    return arguments.length ? (sort4 = _2, sortValues = null, pie) : sort4;
  };
...
MonotoneX.prototype = {
  ...
  point: function(x5, y4) {
    ...
    switch (this._point) {
      ...
      case 2:
        this._point = 3;
        point5(this, slope2(this, t15 = slope3(this, x5, y4)), t15);
        break;
      default:
        point5(this, this._t0, t15 = slope3(this, x5, y4));
        break;
    }
    this._x0 = this._x1, this._x1 = x5;
    this._y0 = this._y1, this._y1 = y4;
...
function insideOut_default(series) {
  var n4 = series.length, i4, j4, sums = series.map(sum3), order = appearance_default(series), top = 0, bottom = 0, tops = [], bottoms = [];
  for (i4 = 0; i4 < n4; ++i4) {
    j4 = order[i4];
    if (top < bottom) {
      top += sums[j4];
...
function formatPrefixAuto_default2(x5, p4) {
  ...
  if (!d3) return x5 + "";
  var coefficient = d3[0], exponent = d3[1], i4 = exponent - (prefixExponent2 = Math.max(-8, Math.min(8, Math.floor(exponent / 3))) * 3) + 1, n4 = coefficient.length;
  return i4 === n4 ? coefficient : i4 > n4 ? coefficient + new Array(i4 - n4 + 1).join("0") : i4 > 0 ? coefficient.slice(0, i4) + "." + coefficient.slice(i4) : "0." + new Array(1 - i4).join("0") + formatDecimalParts2(x5, Math.max(0, p4 + i4 - 1))[0];
}
...
var formatTypes_default2 = {
  ...
  "p": function(x5, p4) {
    return formatRounded_default2(x5 * 100, p4);
  },
...
function locale_default2(locale5) {
  ...
  function formatPrefix3(specifier, value) {
    var f3 = newFormat((specifier = formatSpecifier2(specifier), specifier.type = "f", specifier)), e7 = Math.max(-8, Math.min(8, Math.floor(exponent_default2(value) / 3))) * 3, k5 = Math.pow(10, -e7), prefix2 = prefixes3[8 + e7 / 3];
    return function(value2) {
      return f3(k5 * value2) + prefix2;
    };
  }
...
var second3 = newInterval2(function(date) {
  date.setTime(date - date.getMilliseconds());
}, function(date, step) {
...
var utcMinute3 = newInterval2(function(date) {
  date.setUTCSeconds(0, 0);
}, function(date, step) {
  date.setTime(+date + step * durationMinute3);
}, function(start2, end) {
...
var utcHour3 = newInterval2(function(date) {
  date.setUTCMinutes(0, 0, 0);
}, function(date, step) {
  date.setTime(+date + step * durationHour3);
}, function(start2, end) {
...
var utcDay3 = newInterval2(function(date) {
  date.setUTCHours(0, 0, 0, 0);
}, function(date, step) {
  date.setUTCDate(date.getUTCDate() + step);
}, function(start2, end) {
...
var utcMonth3 = newInterval2(function(date) {
  date.setUTCDate(1);
  date.setUTCHours(0, 0, 0, 0);
}, function(date, step) {
  date.setUTCMonth(date.getUTCMonth() + step);
...
var utcYear3 = newInterval2(function(date) {
  date.setUTCMonth(0, 1);
  date.setUTCHours(0, 0, 0, 0);
}, function(date, step) {
  date.setUTCFullYear(date.getUTCFullYear() + step);
...
function ascending_default3(a4, b4) {
  return a4 < b4 ? -1 : a4 > b4 ? 1 : a4 >= b4 ? 0 : NaN;
}
...
function ticker3(year3, month3, week, day3, hour3, minute3) {
  const tickIntervals = [
    [second_default2, 1, durationSecond3],
    [second_default2, 5, 5 * durationSecond3],
    [second_default2, 15, 15 * durationSecond3],
    [second_default2, 30, 30 * durationSecond3],
    [minute3, 1, durationMinute3],
    [minute3, 5, 5 * durationMinute3],
    [minute3, 15, 15 * durationMinute3],
    [minute3, 30, 30 * durationMinute3],
    [hour3, 1, durationHour3],
    [hour3, 3, 3 * durationHour3],
    [hour3, 6, 6 * durationHour3],
    [hour3, 12, 12 * durationHour3],
    [day3, 1, durationDay3],
    [day3, 2, 2 * durationDay3],
  ...
  function tickInterval(start2, stop2, count4) {
    ...
    if (i4 === tickIntervals.length) return year3.every(tickStep3(start2 / durationYear3, stop2 / durationYear3, count4));
    if (i4 === 0) return millisecond_default2.every(Math.max(tickStep3(start2, stop2, count4), 1));
    const [t7, step] = tickIntervals[target / tickIntervals[i4 - 1][2] < tickIntervals[i4][2] / target ? i4 - 1 : i4];
    return t7.every(step);
  }
  return [ticks2, tickInterval];
}
var [utcTicks3, utcTickInterval3] = ticker3(utcYear_default2, utcMonth_default2, utcSunday3, utcDay_default2, utcHour_default2, utcMinute_default2);
var [timeTicks3, timeTickInterval3] = ticker3(year_default2, month_default2, sunday2, day_default2, hour_default2, minute_default2);
...
function formatLocale2(locale5) {
  ...
  function newFormat(specifier, formats2) {
    return function(date) {
      ...
      while (++i4 < n4) {
        if (specifier.charCodeAt(i4) === 37) {
          string.push(specifier.slice(j4, i4));
          if ((pad3 = pads2[c9 = specifier.charAt(++i4)]) != null) c9 = specifier.charAt(++i4);
          else pad3 = c9 === "e" ? " " : "0";
          if (format3 = formats2[c9]) c9 = format3(date, pad3);
          string.push(c9);
          j4 = i4 + 1;
  ...
  function newParse(specifier, Z2) {
    return function(string) {
      var d3 = newDate2(1900, void 0, 1), i4 = parseSpecifier(d3, specifier, string += "", 0), week, day3;
      if (i4 != string.length) return null;
      if ("Q" in d3) return new Date(d3.Q);
      if ("s" in d3) return new Date(d3.s * 1e3 + ("L" in d3 ? d3.L : 0));
      if (Z2 && !("Z" in d3)) d3.Z = 0;
      ...
      if ("V" in d3) {
        ...
        if ("Z" in d3) {
          ...
          week = day3 > 4 || day3 === 0 ? utcMonday3.ceil(week) : utcMonday3(week);
...
function parseWeekdayNumberSunday2(d3, string, i4) {
  var n4 = numberRe2.exec(string.slice(i4, i4 + 1));
  return n4 ? (d3.w = +n4[0], i4 + n4[0].length) : -1;
}
...
function parseWeekNumberSunday2(d3, string, i4) {
  var n4 = numberRe2.exec(string.slice(i4, i4 + 2));
  return n4 ? (d3.U = +n4[0], i4 + n4[0].length) : -1;
}
...
function parseFullYear2(d3, string, i4) {
  var n4 = numberRe2.exec(string.slice(i4, i4 + 4));
  return n4 ? (d3.y = +n4[0], i4 + n4[0].length) : -1;
}
...
function parseDayOfYear2(d3, string, i4) {
  var n4 = numberRe2.exec(string.slice(i4, i4 + 3));
  return n4 ? (d3.m = 0, d3.d = +n4[0], i4 + n4[0].length) : -1;
}
...
function parseMicroseconds2(d3, string, i4) {
  var n4 = numberRe2.exec(string.slice(i4, i4 + 6));
  return n4 ? (d3.L = Math.floor(n4[0] / 1e3), i4 + n4[0].length) : -1;
}
function parseLiteralPercent2(d3, string, i4) {
  var n4 = percentRe2.exec(string.slice(i4, i4 + 1));
  return n4 ? i4 + n4[0].length : -1;
}
function parseUnixTimestamp2(d3, string, i4) {
  var n4 = numberRe2.exec(string.slice(i4));
  return n4 ? (d3.Q = +n4[0], i4 + n4[0].length) : -1;
}
...
function formatZone2(d3) {
  var z5 = d3.getTimezoneOffset();
  return (z5 > 0 ? "-" : (z5 *= -1, "+")) + pad2(z5 / 60 | 0, "0", 2) + pad2(z5 % 60, "0", 2);
}
...
function formatUTCWeekNumberSunday2(d3, p4) {
  return pad2(utcSunday3.count(utcYear_default2(d3) - 1, d3), p4, 2);
}
function UTCdISO2(d3) {
  var day3 = d3.getUTCDay();
  return day3 >= 4 || day3 === 0 ? utcThursday3(d3) : utcThursday3.ceil(d3);
}
function formatUTCWeekNumberISO2(d3, p4) {
  d3 = UTCdISO2(d3);
  return pad2(utcThursday3.count(utcYear_default2(d3), d3) + (utcYear_default2(d3).getUTCDay() === 4), p4, 2);
}
function formatUTCWeekdayNumberSunday2(d3) {
  return d3.getUTCDay();
}
function formatUTCWeekNumberMonday2(d3, p4) {
  return pad2(utcMonday3.count(utcYear_default2(d3) - 1, d3), p4, 2);
}
...
function formatUTCFullYearISO2(d3, p4) {
  var day3 = d3.getUTCDay();
  d3 = day3 >= 4 || day3 === 0 ? utcThursday3(d3) : utcThursday3.ceil(d3);
  return pad2(d3.getUTCFullYear() % 1e4, p4, 4);
}
...
var Ir = function(e7, r4) {
  var t7 = (0, import_merge4.default)({}, e7, r4);
  return Gr.forEach(function(e8) {
    (0, import_set3.default)(t7, e8, Lr((0, import_get.default)(t7, e8), t7.text));
  }), t7;
};
...
var at = { ascending: ascending_default2, descending: descending_default3, insideOut: insideOut_default, none: none_default2, reverse: reverse_default };
...
var xt = function(e7) {
  return "function" == typeof e7 ? e7 : "string" == typeof e7 ? 0 === e7.indexOf("time:") ? timeFormat2(e7.slice("5")) : format2(e7) : function(e8) {
    return "" + e8;
  };
};
var Ot = function(e7) {
      ...
      if (Ln(d4, r5, o4)) {
        ...
        if (f3) {
          if (Gn.includes(f3.type)) if ("inherit" === f3.background || "inherit" === f3.color) {
            ...
            "inherit" === f3.background && (b4 = b4 + ".bg." + p4, h3 = p4), "inherit" === f3.color && (b4 = b4 + ".fg." + p4, g3 = p4), (0, import_set3.default)(r5, s4, "url(#" + b4 + ")"), c9[b4] || (u3.push(jr({}, f3, { id: b4, background: h3, color: g3 })), c9[b4] = 1);
          } else (0, import_set3.default)(r5, s4, "url(#" + l4 + ")");
            ...
            if (f3.colors.map(function(e8) {
              ...
              w4.id = _2, (0, import_set3.default)(r5, s4, "url(#" + _2 + ")"), c9[_2] || (u3.push(w4), c9[_2] = 1);
            } else (0, import_set3.default)(r5, s4, "url(#" + l4 + ")");
          }
        }
        return "break";
