            ...
            <div className="autocomplete">
                <header>
                    <label>
                        ...
                        <input onChange={changeWaterName} placeholder='hint: Try searching "lake" or "stream"'/>
                    </label>
                </header>
                <ul ref={resultsRef} className={`results ${filteredResults.length || waterName ? 'has-results' : null}`}>
                {filteredResults.length
                            ...
                            ? (
                                <li>
                                    <InternalLink 
                                        ...
                                        breadCrumb={{position: 2, label: result.water.name}}
                                    >
                                        {result.water.name}
                                    </InternalLink>
                                </li>
                    ...
                    : waterName ? <div>(no results)</div> : null
                }
                </ul>
